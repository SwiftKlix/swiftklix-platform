...
import { X, Lock, Mail, User, ShieldCheck, Sparkles, ArrowRight, Check } from 'lucide-react';
...
export default function AuthModal({ isOpen, onClose, onLogin }) {
  ...
  const handleGoogleLogin = () => {
    onLogin({
      ...
      role: 'admin',
      accountType: 'Organization Founder & Changemaker',
      provider: 'google'
    });
    onClose();
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs">
      <div className="bg-white rounded-3xl w-full max-w-md border border-slate-200 shadow-2xl overflow-hidden text-xs">
        ...
        <div className="p-6 pt-4 text-center">
          ...
          <p className="text-slate-500 text-[11px] mt-1 mb-5">
            {authMode === 'signin' 
              ? "Sign in to manage your branch applications, matching scores, and organization hub."
              : "Join our global network of changemakers, branch leaders, and mission-driven organizations."}
          </p>
          ...
          {error && (
            <div className="p-2.5 rounded-xl bg-red-50 text-red-700 font-medium text-[11px] mb-3 text-left">
              {error}
            </div>
          )}
          ...
          <div className="flex items-center my-4">
            ...
            <span className="px-2 text-[10px] text-slate-400 uppercase font-bold">or</span>
            <div className="flex-1 border-t border-slate-200"></div>
          </div>
