            ...
            return (
              <div key={opp.id} className="clean-card overflow-hidden flex flex-col justify-between group hover:border-slate-300 hover:shadow-md transition-all">
                ...
                <div className="relative h-32 w-full bg-slate-100 overflow-hidden">
                  ...
                  <div className="absolute -bottom-5 left-4 w-16 h-16 rounded-full bg-white p-1.5 shadow-xl border-3 border-white flex items-center justify-center z-10 overflow-hidden ring-1 ring-slate-200/80">
                    {org?.logo ? (
