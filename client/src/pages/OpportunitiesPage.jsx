            ...
            return (
              <div key={org.id} className="clean-card overflow-hidden flex flex-col justify-between group hover:border-slate-300 hover:shadow-md transition-all">
                ...
                <div className="relative h-36 w-full bg-slate-100 overflow-hidden">
                  ...
                  <div className="absolute -bottom-3 left-3.5 w-11 h-11 rounded-full bg-white p-0.5 shadow-md border border-slate-200 flex items-center justify-center z-10 overflow-hidden">
                    {org.logo ? (
                ...
                {/* Body */}
                <div className="p-5 pt-5 flex-1 flex flex-col justify-between text-xs">
                  <div>
